...
public static async Task<HttpResponseMessage> Run(HttpRequestMessage req, TraceWriter log)
{
    ...
    log.Info($"Getting Vote Rating from paramter");
    ...
    string SQLServer = GetKeyVaultSecret("ExpertsLiveSQLServerFQDN");
    string SQLDB = GetKeyVaultSecret("VotingSQLDB");
    string SQLServerUserName = GetKeyVaultSecret("ExpertsLiveSQLServerUserName");
    string SQLServerPassword = GetKeyVaultSecret("ExpertsLiveSQLServerPassword");
    ...
    //SQL queries
    string SQLQueryTemplate = "INSERT CloudAutomation.Vote (RatingId, ClientIP, SubmissionDate) VALUES ({0}, '{1}', GETUTCDATE())";
    if (rating != null)
    {
